...
//     if (data.success) {
//       setUsers(data.data);
//       setLoading(false) // Set the users from the API response
//     } else {
//       console.error('Failed to fetch users:', data.message);
//     }
//   };
...
//         setUsers((prevUser) => prevUser.filter(user => user._id !== userId)); // Remove deleted post
//         setShowDel(false);
//         setConfirmation(true);
...
//       <div className="flex justify-between mb-6">
//         <h1 className="text-2xl font-semibold">{!userRole ? 'Info' : 'All users'}</h1>
//         {userRole ? (
...
//         }`}
//       >
//         <td className="py-3 px-4 text-gray-800 text-center">{index + 1}</td>
//         <td className="py-3 px-4 text-gray-800">
//           {user.first_name} {user.last_name}
//         </td>
//         <td className="py-3 px-4 text-gray-800">{user.username}</td>
